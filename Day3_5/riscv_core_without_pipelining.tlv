   ...
   |cpu
      ...
      @1
         ...
         ?$rs1_valid
            ...
            $src1_value[31:0] = $rf_rd_data1 ; //output 1
         
         ?$rs2_valid
            $rf_rd_en2 = 1 ;
            $rf_rd_index2[4:0] = $rs2 ;
            
            $src2_value[31:0] = $rf_rd_data2 ; //output 2
         ...
         //Write Reg File
         ?$rd_valid
            $rf_wr_en = ($rd[4:0] != 5'b00000) ;
            $rf_wr_index[4:0] = $rd ;
            //$rf_wr_data[31:0] = $result ;
         
         $value[31:0] = $rf_wr_en ? $result : >>1$value ;
